...
class DeployToProfile
{
    ...
    public function getConfig(
        ...
        $config = array_merge(
            $config,
            $latestData['envVariables'] == '' ? [] : json_decode((string) $latestData['envVariables'], true)
        );
    ...
    public function deployToHosts(
        ...
        $config = $this->getConfig($cloudConfigId, $cloudConfigRevId, $extraConfigParams, $vendorData);
        $deployResults = [];
