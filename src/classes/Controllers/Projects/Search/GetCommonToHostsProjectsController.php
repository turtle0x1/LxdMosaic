...
class GetCommonToHostsProjectsController
{
    ...
    /**
     * @Route("/api/Projects/Search/GetCommonToHostsProjectsController/get", methods={"POST"}, name="Get list of projects on all selected hosts", options={"rbac" = "projects.read"})
     */
