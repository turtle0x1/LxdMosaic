...
<script>
    $(function() {
        ...
        $("#siteLogo").delay(0).animate({
            opacity: 1
        }, 2000);
        $("#welcomeHeading").delay(1000).animate({
            opacity: 1
        }, 2500);
        $("#welcomeText").delay(2500).animate({
            opacity: 1
        }, 2500);
        $("#footer").delay(4000).animate({
            opacity: 1
        }, 2000);
        $("#getStartedBtn").delay(6000).animate({
            opacity: 1
        }, 2000);
    ...
    $(document).on("click", "#addServer", function() {
        ...
        <nav>
          <div class="nav nav-pills mb-3" id="host-nav" role="tablist">
            <button class="nav-link  active" id="nav-token-tab" data-bs-toggle="tab" data-bs-target="#nav-token" type="button" role="tab" aria-controls="nav-token" aria-selected="true">Token</button>
            <button class="nav-link" id="nav-network-tab" data-bs-toggle="tab" data-bs-target="#nav-network" type="button" role="tab" aria-controls="nav-network" aria-selected="true">Trust Password (Depreciated)</button>
            <button class="nav-link" id="nav-socket-tab" data-bs-toggle="tab" data-bs-target="#nav-socket" type="button" role="tab" aria-controls="nav-socket" aria-selected="false">Socket</button>
          </div>
        </nav>
            ...
            buttons: {
                ...
                add: {
                    ...
                    action: function() {
                        ...
                        $("#serverGroups").append(`<a href="#" class="list-group-item list-group-item-action newHost" data-alias="${alias}" data-name="${name}" data-trust-password="${trustPassword}" data-socket-path="${socketPath}" data-token="${token}">
                       <div class="d-flex w-100 justify-content-between">
